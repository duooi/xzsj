window.addEventListener("load", function () {
    ...
    (function () {
        ...
        var nav = tool.getEleByClass("navtop_r")[0];
        ...
        (function () {
            ...
            //倒计时效果
            var eTime = new Date("2020/7/5 00:00").getTime();
            var sTime = 0, mSeconds = 0, hour = 0, minute = 0, second = 0;
            ...
            //模块控制显示、隐藏
            var module = tool.getEleByClass("module_c");
            for (var i = 0; i < module.length; i++) {
                (function (i) {
                    var introBtns = module[i].children[1].children;
                    var introItems = module[i].children[2].children[1].children;

                    for (var j = 0; j < introBtns.length; j++) {
                        (function (j) {
                            introBtns[j].addEventListener("mouseover", function (evt) {
                                for (var k = 0; k < introItems.length; k++) {
                                    tool.removeClass(introBtns[k],"active");
                                    introItems[k].style.display = "none";
                                }
                                introItems[j].style.display = "block";
